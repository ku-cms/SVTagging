...
config.General.requestName = 'TTJets-DiLept-FastSim-2016-v2'
config.General.transferOutputs = True
config.General.transferLogs = True

config.section_('JobType')
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'SUS-RunIISummer16NanoAODv4-fastsim-cfg.py'
config.JobType.outputFiles = ['TTJets-DiLept-FastSim-2016.root']
...
config.Data.inputDataset = '/TTJets_DiLept_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/RunIISummer16MiniAODv3-PUSummer16v3Fast_lhe_94X_mcRun2_asymptotic_v3-v1/MINIAODSIM'
